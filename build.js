...
<title>${esc(p.title)} · HWANG YUNJIN</title>
...
@media(max-width:800px){.article-shell{padding:26px 22px 82px}.article-hero{display:block;padding:62px 0 48px}.hero-index{min-height:auto;flex-direction:row;align-items:center;margin-bottom:42px}.hero-index strong{font-size:54px}.hero-copy h1{font-size:clamp(42px,13.2vw,61px);line-height:1.1}.dek{margin-top:28px;font-size:17px;line-height:1.85}.meta{margin-top:27px;gap:14px;flex-wrap:wrap}.article-layout{display:block;padding-top:42px}.article-aside{display:none}.article-body{font-size:16px;line-height:1.95}.article-body h2{margin-top:78px;font-size:26px}.article-body blockquote{margin-top:64px;margin-bottom:64px;padding:36px 18px}.editorial-figure{margin-top:62px;margin-bottom:70px;padding:24px 0 28px}.editorial-figure figcaption{margin-bottom:26px}.figure-flow,.figure-flow.cycle{display:flex;flex-direction:column;align-items:stretch;gap:8px}.editorial-figure i{transform:rotate(90deg);align-self:center}.figure-flow>div{min-height:96px}.article-footer{display:block;margin-top:76px}.article-footer small{display:none}}
</style>
</head>
<body>
<div class="reading-progress" id="reading-progress"></div>
<main class="article-shell">
<nav class="post-nav"><a href="/">HWANG YUNJIN</a><span>WRITING / ${cat}</span></nav>
<header class="article-hero">
  <aside class="hero-index"><strong>01</strong><div>WRITING<br>${cat}</div></aside>
...
<footer class="article-footer"><small>HWANG YUNJIN / WRITING</small><a class="back" href="/#writing">← BACK TO WRITING</a></footer>
</main>
